...
} from "@/constants/dashboard/webhooks/retry";
import { buildWebhookHeaders } from "@/lib/dashboard/webhooks/signing";
...
export async function dispatchWebhookEvent(input: {
  ...
  void import("@/lib/dashboard/integrations/notifications/dispatch").then(
    ({ dispatchIntegrationNotifications }) =>
      dispatchIntegrationNotifications({
...
export function buildTestWebhookPayload() {
  ...
  return {
    ...
    settlement_asset: {
      asset_code: "USDC",
      issuer_address: "GBBD47IF6LWK7P7MDEVSCWR7DPUWV3NY3DTQEVFL4NAT4AQH3ZLLFLA5",
    },
    paid_asset: {
      asset_code: "USDC",
      issuer_address: "GBBD47IF6LWK7P7MDEVSCWR7DPUWV3NY3DTQEVFL4NAT4AQH3ZLLFLA5",
    ...
    status: "pending",
    description: "KailoPay webhook test event",
    metadata: { kailopay_test: "true" },
    checkout_url: null,
    source_type: "direct",
    customer_id: null,
    payer_address: null,
