...
import { PERSONA_API_URL, PERSONA_API_VERSION } from "@/constants/dashboard/kyc";
...
export function getPersonaPublicConfig() {
  ...
  return {
    environmentId: publicEnv.personaEnvironmentId,
    templateId: publicEnv.personaInquiryTemplateId,
