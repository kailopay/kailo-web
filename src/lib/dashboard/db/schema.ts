...
export const paymentFlowEnum = pgEnum("payment_flow", [
  "direct",
  "soroban",
  "escrow",
  "zk_shielded",
...
export const payments = pgTable(
  "payments",
  {
    ...
    shieldedPoolContractId: text("shielded_pool_contract_id"),
    zkNullifier: text("zk_nullifier"),
    zkDepositTxHash: text("zk_deposit_tx_hash"),
    zkLeafIndex: integer("zk_leaf_index"),
    zkWithdrawTxHash: text("zk_withdraw_tx_hash"),
