...
import { customers, payments, type Customer, type Organization } from "@/lib/dashboard/db/schema";
import { organizationEnvironmentWhere } from "@/lib/dashboard/organizations/environment-scope";
import { isValidStellarAddress } from "@/lib/dashboard/stellar/validate-address";
