...
import { AddAssetDialog } from "@/components/dashboard/payment-methods/add-asset-dialog";
...
import { useTrustlineSetup, type MissingTrustlineAsset } from "@/hooks/dashboard/use-trustline-setup";
...
import type { SerializedPaymentMethod } from "@/lib/dashboard/payment-methods/service";
  ...
  return (
    <div className="mb-6 space-y-6">
      ...
      <SettingsSection
        ...
        titleTooltip="Cross-asset payments are converted into this asset on-chain when possible. If conversion fails (for example due to liquidity), KailoPay sends the payment to your settlement wallet in the asset the customer paid with."
