...
import { IntegrationDetailFormSkeleton } from "@/components/dashboard/ui/integrations/integration-detail-skeleton";
...
export function ShopifyIntegrationPanel({
  ...
  const headerOverride = useMemo(
    () => ({
      titleInfo: {
        title:
          "Connect to receive Shopify order events and create hosted checkout payments.",
      },
    }),
    [],
  );
  ...
  return (
    <div className="space-y-6">
      <SettingsSection
        title="Shopify store"
        description="Connect your Shopify store to create KailoPay payments when pending orders are created."
        helpText={
          isLoading ? (
