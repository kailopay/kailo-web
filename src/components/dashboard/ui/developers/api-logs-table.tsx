...
import { API_LOGS_PAGE_SIZE, METHOD_BADGE_VARIANTS } from "@/lib/dashboard/api-logs/constants";
import { getStatusCodeBadgeVariant } from "@/lib/dashboard/api-logs/log-utils";
import type { ApiLogRow } from "@/lib/dashboard/api-logs/types";
import { ApiLogsFilters } from "@/components/dashboard/ui/developers/use-api-log-filters";
import { ApiLogsTableSkeleton } from "@/components/dashboard/ui/developers/api-logs-table-skeleton";
...
export function ApiLogsTable({ organizationId }: { organizationId: string }) {
  ...
  const { columnVisibility, setColumnVisibility } = useColumnVisibility(
    "kailopay-api-logs-table-columns",
    apiLogsColumns,
  );
