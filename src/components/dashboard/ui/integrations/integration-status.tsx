...
import type { PublicOrganizationIntegration } from "@/lib/dashboard/integrations/types";
...
export function IntegrationStatus({
  ...
  integration: OrganizationIntegration | PublicOrganizationIntegration | null | undefined;
}) {
