...
import type { CustomerPaymentRow } from "@/lib/dashboard/customers/types";
import { formatAssetAmount } from "@/lib/dashboard/payments/types";
import {
  CopyText,
  StatusBadge,
  Table,
...
import { CustomerPaymentsTableSkeleton } from "@/components/dashboard/ui/customers/customer-payments-table-skeleton";
