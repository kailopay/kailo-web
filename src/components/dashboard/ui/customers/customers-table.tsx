...
import { CustomerRowItem } from "@/components/dashboard/ui/customers/customer-row-item";
import { CustomersFilters } from "@/components/dashboard/ui/customers/use-customer-filters";
import { CustomersTableSkeleton } from "@/components/dashboard/ui/customers/customers-table-skeleton";
...
export function CustomersTable({
  ...
  const { columnVisibility, setColumnVisibility } = useColumnVisibility(
    "kailopay-customers-table-columns",
    customersColumns,
  );
