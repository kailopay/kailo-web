...
import { PaymentsFilters } from "@/components/dashboard/ui/payments/use-payment-filters";
import { PaymentsTableSkeleton } from "@/components/dashboard/ui/payments/payments-table-skeleton";
...
export function PaymentsTable({
  ...
  const { columnVisibility, setColumnVisibility } = useColumnVisibility(
    "kailopay-payments-table-columns",
    paymentsColumns,
  );
