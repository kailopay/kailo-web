...
import { InvoicesFilters } from "@/components/dashboard/ui/invoices/use-invoice-filters";
import { InvoicesTableSkeleton } from "@/components/dashboard/ui/invoices/invoices-table-skeleton";
...
export function InvoicesTable({
  ...
  const { columnVisibility, setColumnVisibility } = useColumnVisibility(
    "kailopay-invoices-table-columns",
    invoiceColumns,
  );
