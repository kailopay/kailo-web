...
import { InvoiceChangeCustomerDialog } from "@/components/dashboard/invoices/invoice-change-customer-dialog";
import { InvoiceEditDialog } from "@/components/dashboard/invoices/invoice-edit-dialog";
...
import {
  ...
  canResendInvoice,
  canVoidInvoice,
} from "@/lib/dashboard/invoices/activity";
import { getPaymentsHubHref } from "@/lib/dashboard/navigation/payments-tabs";
import type { InvoiceRow } from "@/lib/dashboard/payments/types";
import { InvoiceDetailSkeleton } from "@/components/dashboard/ui/payments/invoice-detail-skeleton";
import { InvoiceDetailStats } from "@/components/dashboard/ui/payments/invoice-detail-stats";
import { InvoiceDetailsColumn } from "@/components/dashboard/ui/payments/invoice-details-column";
import {
  InvoiceActivitySection,
  InvoiceLineItemsSection,
  InvoiceMetadataSection,
} from "@/components/dashboard/ui/payments/invoice-sections";
import { getInvoiceRowStatusLabel, getInvoiceRowStatusVariant } from "@/components/dashboard/ui/payments/payment-formatters";
