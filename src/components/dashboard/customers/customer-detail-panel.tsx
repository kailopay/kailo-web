...
import { useEditCustomerSheet } from "@/components/dashboard/customers/use-edit-customer-sheet";
import { AlertBlock } from "@/components/dashboard/shared/alert-block";
import { useAsyncData } from "@/hooks/dashboard/use-async-data";
import type { CustomerDetail, CustomerRow } from "@/lib/dashboard/customers/types";
import { formatCustomerLabel } from "@/lib/dashboard/customers/types";
import { CustomerDetailSkeleton } from "@/components/dashboard/ui/customers/customer-detail-skeleton";
import { CustomerDetailsColumn } from "@/components/dashboard/ui/customers/customer-details-column";
import { CustomerPaymentsTable } from "@/components/dashboard/ui/customers/customer-payments-table";
import { CustomerStats } from "@/components/dashboard/ui/customers/customer-stats";
