...
declare function usesMarketingSession(domain: string): boolean;
declare function getMarketingAuthUrls(domain: string): {
    login: string;
    register: string;
    dashboard: string;
};
